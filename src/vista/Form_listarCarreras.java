 ...
 * @author USRVI-LC2
 */
public class Form_listarCarreras extends javax.swing.JFrame {

    /**
     * Creates new form Form_listarCarreras
     */
    public Form_listarCarreras() {
        initComponents();
    }
    ...
    private void jbtn_listarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtn_listarActionPerformed
       ...
       String nombre = "";
        ...
        List<Carrera> lista = reg.buscarTodos();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_listarCarreras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_listarCarreras().setVisible(true);
            }
        });
    }
